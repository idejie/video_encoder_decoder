...
class TRTInference:
    def __init__(self, trt_engine_datatype, batch_size, trt_engine_path="./encoder.trt"):
    ...
    def infer(self, image):
        ...
        stream.synchronize()
        # print("execute times "+str(1000*(time.time()-start_time)))
...
while True:
    ...
    if  data_in['input_image'] is None:
        ...
        # print('frame',data_in['frame_num'],end='\r')
